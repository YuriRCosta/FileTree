...
QtObject {
  ...
  function status(): string {
    return JSON.stringify({
      ...
      capacityState: service.capacity.status,
      capacityShown: service.capacityShown,
      capacityFraction: service.capacity.status === "ready" ? service.capacity.fraction : -1,
      capacityPercent: service.capacity.status === "ready" ? service.capacity.percent : -1,
      capacityUsed: service.capacity.status === "ready" ? service.capacity.used : -1,
      capacitySize: service.capacity.status === "ready" ? service.capacity.size : -1,
      capacityAvailable: service.capacity.status === "ready" ? service.capacity.available : -1,
      capacityMount: service.capacity.status === "ready" ? service.capacity.mountpoint : "",
      capacityTip: service.capacityTip,
      capacityRequestCount: service.capacity.requestCount,
