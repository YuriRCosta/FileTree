...
QtObject {
  ...
  property QtObject tooltip: QtObject { property color background: "#1a1b26"; property color border: "#333333"; property color text: "#eeeeee" }
  property color accent: "#7aa2f7"
  property QtObject menu: QtObject { property color selectedBackground: "#333333" }
