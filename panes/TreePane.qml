...
FocusScope {
  ...
  function runBrowserAction(action) {
    var actions = {
      ...
      downloads: function() { if (controller.downloadsPath) controller.setRootPath(controller.downloadsPath) },
  ...
  PluginUi.PaneView {
    ...
    navigationActions: [
      ...
      { key: "downloads", glyph: "󰉍", title: "Downloads",
        enabled: controller.downloadsPath !== "" && controller.rootPath !== controller.downloadsPath,
        actions: [{ button: "left", text: "Downloads" }],
        context: [{ glyph: "󰉋", text: controller.downloadsPath }] },
